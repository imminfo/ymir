...
//            }
    ...
    public:
        ...
        */
        const vector<numeric>& computeFullProbabilities(const ClonalRepertoireView& repertoire, bool aminoacid = false) const {
...
//        }
        ...
        */
        ClonalRepertoire generateSequences(size_t count = 1) const {
            if (!_generator) {
                // make generator
            }
