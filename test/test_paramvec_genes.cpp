...
YMIR_TEST_START(test_model_param_vec_vj)
    ...
    YMIR_ASSERT3(mvec.eventClassSize(VJ_VAR_JOI_GEN), 9)
    YMIR_ASSERT3(mvec.eventClassSize(VJ_VAR_DEL), 9)
    YMIR_ASSERT3(mvec.eventFamilySize(VJ_VAR_DEL, 0), 2)
    YMIR_ASSERT3(mvec.eventFamilySize(VJ_VAR_DEL, 2), 4)
    YMIR_ASSERT3(mvec.eventClassSize(VJ_JOI_DEL), 5)
    YMIR_ASSERT3(mvec.eventFamilySize(VJ_JOI_DEL, 0), 2)
    YMIR_ASSERT3(mvec.eventFamilySize(VJ_JOI_DEL, 1), 3)
    YMIR_ASSERT3(mvec.eventClassSize(VJ_VAR_JOI_INS_LEN), 5)
    YMIR_ASSERT3(mvec.eventFamilySize(VJ_VAR_JOI_INS_LEN, 0), 5)
    YMIR_ASSERT3(mvec.eventClassSize(VJ_VAR_JOI_INS_NUC), 4)
    YMIR_ASSERT3(mvec.eventFamilySize(VJ_VAR_JOI_INS_NUC, 0), 4)

    YMIR_ASSERT3(mvec.event_prob(VJ_VAR_JOI_GEN, 0, 0, 1), .025)
    YMIR_ASSERT3(mvec.event_prob(VJ_VAR_JOI_GEN, 0, 2, 0), .075)

    YMIR_ASSERT3(mvec.event_prob(VJ_VAR_DEL, 0, 0), .75)
    YMIR_ASSERT3(mvec.event_prob(VJ_VAR_DEL, 0, 1), .25)
    YMIR_ASSERT3(mvec.event_prob(VJ_VAR_DEL, 1, 0), .4)
    YMIR_ASSERT3(mvec.event_prob(VJ_VAR_DEL, 1, 1), .5)
    YMIR_ASSERT3(mvec.event_prob(VJ_VAR_DEL, 1, 2), .1)
    YMIR_ASSERT3(mvec.event_prob(VJ_VAR_DEL, 2, 0), .3)
    YMIR_ASSERT3(mvec.event_prob(VJ_VAR_DEL, 2, 3), .4)

    YMIR_ASSERT3(mvec.event_prob(VJ_JOI_DEL, 0, 0), .4)
    YMIR_ASSERT3(mvec.event_prob(VJ_JOI_DEL, 0, 1), .6)
    YMIR_ASSERT3(mvec.event_prob(VJ_JOI_DEL, 1, 0), .125)
    YMIR_ASSERT3(mvec.event_prob(VJ_JOI_DEL, 1, 2), .7)

    YMIR_ASSERT3(round(mvec.event_prob(VJ_VAR_JOI_INS_LEN, 0, 0) * 100) / 100, .31)
    YMIR_ASSERT3(round(mvec.event_prob(VJ_VAR_JOI_INS_LEN, 0, 1) * 100) / 100, .39)
    YMIR_ASSERT3(round(mvec.event_prob(VJ_VAR_JOI_INS_LEN, 0, 2) * 100) / 100, .1)
    YMIR_ASSERT3(mvec.max_VJ_ins_len(), 4)

    YMIR_ASSERT3(mvec[mvec.event_index(VJ_VAR_JOI_INS_NUC, 0, 0)], .05)
    YMIR_ASSERT3(mvec[mvec.event_index(VJ_VAR_JOI_INS_NUC, 0, 0) + 1], .08)
    YMIR_ASSERT3(mvec[mvec.event_index(VJ_VAR_JOI_INS_NUC, 0, 0) + 4], .4)
YMIR_TEST_END
...
YMIR_TEST_START(test_model_param_vec_vdj)
    ...
    YMIR_ASSERT3(mvec[0], 0)

    YMIR_ASSERT3(mvec.event_prob(VDJ_VAR_GEN, 0, 0), .5)
    YMIR_ASSERT3(mvec.event_prob(VDJ_VAR_GEN, 0, 2), .25)

    YMIR_ASSERT3(mvec.event_prob(VDJ_JOI_DIV_GEN, 0, 0, 0), .01)
    YMIR_ASSERT3(mvec.event_prob(VDJ_JOI_DIV_GEN, 0, 0, 1), .02)
    YMIR_ASSERT3(mvec.event_prob(VDJ_JOI_DIV_GEN, 0, 1, 0), .03)
    YMIR_ASSERT3(mvec.event_prob(VDJ_JOI_DIV_GEN, 0, 1, 1), .04)
    YMIR_ASSERT3(mvec.event_prob(VDJ_JOI_DIV_GEN, 0, 2, 0), .06)
    YMIR_ASSERT3(mvec.event_prob(VDJ_JOI_DIV_GEN, 0, 2, 1), .84)

    YMIR_ASSERT3(mvec.event_prob(VDJ_VAR_DEL, 0, 0), .75)
    YMIR_ASSERT3(mvec.event_prob(VDJ_VAR_DEL, 0, 1), .25)
    YMIR_ASSERT3(mvec.event_prob(VDJ_VAR_DEL, 1, 0), .4)
    YMIR_ASSERT3(mvec.event_prob(VDJ_VAR_DEL, 1, 1), .5)
    YMIR_ASSERT3(mvec.event_prob(VDJ_VAR_DEL, 1, 2), .1)
    YMIR_ASSERT3(mvec.event_prob(VDJ_VAR_DEL, 2, 0), .3)
    YMIR_ASSERT3(mvec.event_prob(VDJ_VAR_DEL, 2, 3), .4)

    YMIR_ASSERT3(mvec.event_prob(VDJ_JOI_DEL, 0, 0), .4)
    YMIR_ASSERT3(mvec.event_prob(VDJ_JOI_DEL, 0, 1), .6)
    YMIR_ASSERT3(mvec.event_prob(VDJ_JOI_DEL, 1, 0), .125)
    YMIR_ASSERT3(mvec.event_prob(VDJ_JOI_DEL, 1, 2), .7)

    YMIR_ASSERT3(mvec.event_prob(VDJ_DIV_DEL, 0, 0, 0), .17)
    YMIR_ASSERT3(mvec.event_prob(VDJ_DIV_DEL, 0, 0, 1), .27)
    YMIR_ASSERT3(mvec.event_prob(VDJ_DIV_DEL, 0, 1, 0), .37)
    YMIR_ASSERT3(mvec.event_prob(VDJ_DIV_DEL, 0, 1, 1), .19)

    YMIR_ASSERT3(mvec.event_prob(VDJ_DIV_DEL, 1, 0, 0), .11)
    YMIR_ASSERT3(mvec.event_prob(VDJ_DIV_DEL, 1, 0, 1), .12)
    YMIR_ASSERT3(mvec.event_prob(VDJ_DIV_DEL, 1, 2, 0), .15)
    YMIR_ASSERT3(mvec.event_prob(VDJ_DIV_DEL, 1, 2, 1), .35)

    YMIR_ASSERT3(mvec.event_prob(VDJ_VAR_DIV_INS_LEN, 0, 0), .76)
    YMIR_ASSERT3(mvec.event_prob(VDJ_VAR_DIV_INS_LEN, 0, 1), .24)
    YMIR_ASSERT3(mvec.max_VD_ins_len(), 1)

    YMIR_ASSERT3(mvec.event_prob(VDJ_DIV_JOI_INS_LEN, 0, 0), .89)
    YMIR_ASSERT3(mvec.event_prob(VDJ_DIV_JOI_INS_LEN, 0, 1), .10)
    YMIR_ASSERT3(mvec.event_prob(VDJ_DIV_JOI_INS_LEN, 0, 2), .01)
    YMIR_ASSERT3(mvec.max_DJ_ins_len(), 2)

    YMIR_ASSERT3(mvec[mvec.event_index(VDJ_VAR_DIV_INS_NUC, 0, 0)], .05)
    YMIR_ASSERT3(mvec[mvec.event_index(VDJ_VAR_DIV_INS_NUC, 0, 0) + 1], .08)
    YMIR_ASSERT3(mvec[mvec.event_index(VDJ_VAR_DIV_INS_NUC, 0, 0) + 4], .4)

    YMIR_ASSERT3(mvec[mvec.event_index(VDJ_DIV_JOI_INS_NUC, 0, 0)], .009)
    YMIR_ASSERT3(mvec[mvec.event_index(VDJ_DIV_JOI_INS_NUC, 0, 0) + 1], .06)
    YMIR_ASSERT3(mvec[mvec.event_index(VDJ_DIV_JOI_INS_NUC, 0, 0) + 4], .39)
YMIR_TEST_END
