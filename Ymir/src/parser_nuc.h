...
#ifndef YMIR_PARSER_NUC_H
#define YMIR_PARSER_NUC_H
...
namespace ymir {
    ...
    class ParserNuc : public ParserBase<ClonotypeNuc> {
...
//            _config_is_loaded = false;
        ...
        ParserNuc(vdj_aligner_t *aligner) : ParserBase(aligner)
        {
        }
